    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/tpWebBd1/ajouterjoueur">Ajouter un joueur</a>
          <a class="dropdown-item" href="/tpWebBd1/ajoutertournoi">Ajouter un tournoi</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/tpWebBd1/listerjoueur">Lister les joueurs</a>
          <a class="dropdown-item" href="/tpWebBd1/listertournoi">Lister les tournois</a>
          <a class="dropdown-item" href="/tpWebBd1/listermatch">Lister les  matchs</a>
        </div>
      </li>
