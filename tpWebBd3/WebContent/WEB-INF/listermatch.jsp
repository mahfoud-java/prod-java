...
<a class="btn btn-primary" href="/tpWebBd3/ajoutermatch" role="button">Ajouter un match</a>
</div>
   ...
   <c:forEach var="match" items="${ listeMatchs }">
   	...
   	<form action="modifiermatch" method="get">
   		<tr>
		      ...
		      <td><c:out value="${ match.joueurV.nom}" /><span>  </span><c:out value="${ match.joueurV.prenom}" /></td> 
		      <td><c:out value="${ match.joueurF.nom }" /><span>  </span><c:out value="${ match.joueurF.prenom }" /></td>     
			  <td>
